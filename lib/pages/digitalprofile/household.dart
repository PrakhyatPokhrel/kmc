...
class Householdpage extends StatefulWidget {
  ...
  final data;
  String? title;
  Householdpage({this.data, this.title});
  _HouseholdpageState createState() =>
      _HouseholdpageState(data: data, title: title);
}
...
class _HouseholdpageState extends State<Householdpage> {
  ...
  _HouseholdpageState({this.data, this.title});
  var navdata;
  List<dynamic> data1 = [];
  List<dynamic> data2 = [];
  List<dynamic> data3 = [];
