...
class LiteracyPage extends StatefulWidget {
  ...
  final data;
  String? title;
  LiteracyPage({this.data, this.title});
  _LiteracyPageState createState() =>
      _LiteracyPageState(data: data, title: title!);
}
...
class _LiteracyPageState extends State<LiteracyPage> {
  ...
  _LiteracyPageState({this.data, this.title});
  var navdata;
  List<dynamic> data1 = [];
  List<dynamic> data2 = [];
  List<dynamic> data3 = [];
        ...
        child: Center(
            child: SfCartesianChart(
              ...
              ColumnSeries<dynamic, dynamic>(
                dataSource: data1,
                xValueMapper: (dynamic sales, _) => sales['key'].toString(),
