...
class AgeChartPage extends StatefulWidget {
  @override
  final data;
  String? title;
  AgeChartPage({this.data, this.title});
  _AgeChartPageState createState() =>
      _AgeChartPageState(data: data, title: title!);
}

class _AgeChartPageState extends State<AgeChartPage> {
  final data;
  String? title;

  _AgeChartPageState({this.data, this.title});
  var navdata;
  List<dynamic> data1 = [];
  List<dynamic> data2 = [];
  List<dynamic> data3 = [];
    ...
    return Container(
        ...
        child: Center(
            child: SfCartesianChart(
                title: ChartTitle(
                    text: " महिला पुरुषको उमेर अनुसार विवरण",
              ...
              ColumnSeries<dynamic, String>(
                ...
                name: navdata['data']['chart'][0]['label'],
              ),
              ColumnSeries<dynamic, String>(
                dataSource: data2,
                xValueMapper: (dynamic sales, _) => sales['key'],
                yValueMapper: (dynamic sales, _) => sales['value'],
                name: navdata['data']['chart'][1]['label'],
              ),
              // ColumnSeries<dynamic, String>(
              //   dataSource: data3,
              //   xValueMapper: (dynamic sales, _) => sales['key'],
              //   yValueMapper: (dynamic sales, _) => sales['value'],
              //   name: navdata['data']['chart'][2]['label'],
              // ),
