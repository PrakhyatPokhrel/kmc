...
class GunasoJGchat extends StatefulWidget {
  final data;
  GunasoJGchat(this.data);
  @override
  _GunasoJGchatState createState() => _GunasoJGchatState();
}

class _GunasoJGchatState extends State<GunasoJGchat> {
  dynamic datalist;
