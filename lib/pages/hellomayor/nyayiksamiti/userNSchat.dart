...
class UserNSChat extends StatefulWidget {
  final data;
  UserNSChat(this.data);
  @override
  _UserNSChatState createState() => _UserNSChatState();
}

class _UserNSChatState extends State<UserNSChat> {
  dynamic datalist;
