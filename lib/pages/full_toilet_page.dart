            ...
            child: Column(
              ...
              children: [
                ...
                Card(
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    Visibility(
                                                                      ...
                                                                      child:Row(
                                                                        children: [
                                                                          AvailabilityIcon(icon: 'disabled.svg',),
                                                                          SizedBox(width: 10,),
                                                                        ],
                                                                      ),
                                                                    ...
                                                                    Visibility(
                                                                      visible: widget.data.data.branches.toiletType=='male'||widget.data.data.branches.toiletType=='all',
                                                                      child:AvailabilityIcon(icon: 'male.svg',),
                                                                    
                                                                     ),
                                                                     SizedBox(width: 10,),
                                                                     
                                                                    Visibility(
                                                                      visible: widget.data.data.branches.toiletType=='female'||widget.data.data.branches.toiletType=='all',
                                                                      child:AvailabilityIcon(icon: 'female.svg',),
                                        ...
                                        mapSection(),
                                        SizedBox(height: 10,),
                                        Text("Maintained By",style: TextStyle(fontSize: 18,color: primary),),
                                        SizedBox(height: 12,),
                                        Card(
                                           shape: RoundedRectangleBorder(
                                            borderRadius: BorderRadius.circular(15.0),
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ClipRRect(
                                                      ...
                                                      child: Image.network("${widget.data.data.branches.organizationImage}",width: 90,height: 90,fit: BoxFit.fill,)),
                                                      SizedBox(width: 10,),
                                                    Column(
                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                      children: [
                                                        ...
                                                        CompanyDetailsText(text: '${widget.data.data.branches.category}',),
                                                        CompanyDetailsText(text: '${widget.data.data.branches.location}',),
                                                        CompanyDetailsText(text: '${widget.data.data.branches.organizationEmail}',),
                                          ...
                                          child: Padding(
                                            padding: const EdgeInsets.all(12.0),
                                                        child:Container(
                                                          ...
                                                          child: Text( "${widget.data.data.branches.organizationDescription}",style: TextStyle(
                                                          ...
                                                          for(var i=0;i<widget.data.data.branches.branchImages.length;i++)...[
                                                            InkWell(
                                                              onTap: (){
                                                                ...
                                                                SingleImageProvider multiImageProvider =SingleImageProvider(CachedNetworkImageProvider('${widget.data.data.branches.branchImages[i]['branch_photos']}'));
...
//  Text("Images",style: TextStyle(fontSize: 18,color: primary),),
 ...
 Text("Rate this toilet",style: TextStyle(fontSize: 18,color: primary),),
 Text("tell others what you think",style: TextStyle(fontSize: 10,color: textPrimaryColor),),
 SizedBox(height: 10,),
                                            rating(context,35,10,(value){reviewPopup(context,value,widget.data.data.branches.id);},0),
                                                    SizedBox(height: 20,),
...
//                                             )
  ...
  mapSection() {
    ...
    double lat = double.parse(widget.data.data.branches.geoLocation.latitude
                                                      ...
                                                      final GalliController controller = GalliController(zoom: 18,authKey: 'c9c7a4c0-2834-4282-94f7-f4c79c40ab0a',initialPosition: LatLng(lat,long));
    return Container(
      height: 300.0,
      child: ClipRRect(
          ...
          //  ],
           markers: [
             GalliMarker(
                 ...
                 markerWidget: const Icon(Icons.location_on_sharp,color: Colors.red,))
           ],
         ),
  ...
  reviewPopup(context,double initialRating,int branchId) {
    return showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: 
                Center(child: Text("Rate this toilet",style: TextStyle(fontSize: 18,color: primary),)),
            ...
            content: Stack(
              ...
              children: <Widget>[
                ...
                // Size
                Align(
                  alignment: Alignment.center,heightFactor: 1,
                  child: Column(
                    ...
                    children: [
                      ClipRRect(
                        clipBehavior: Clip.antiAlias,
                        borderRadius: BorderRadius.circular(10),
                        child: Image.network("${widget.data.data.branches.organizationImage}",width: 120,height: 120,fit: BoxFit.fill,)),
                        SizedBox(height: 20,),
                      Text(
                        "${widget.data.data.branches.organizationName}",
                        overflow:
...
class AvailabilityIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SvgPicture.asset("assets/images/icons/$icon",color: primary,height: 25,width: 25,));
  }
}
